...
init_management_cluster_checks() {
  ...
  # Required variables
  for var in DESTINATION_REPO ENVIRONMENT HUB_PROFILE HUB_CLUSTER_NAME hub_tf_dest LOCAL_WORKING_DIR AUTOMATION_DIR; do
  ...
  HUB_DIR="$LOCAL_WORKING_DIR/$hub_tf_dest/$ENVIRONMENT"
