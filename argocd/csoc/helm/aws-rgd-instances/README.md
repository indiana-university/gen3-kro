...
`AwsGen3NetworkSecurity1` owns the single upstream network bridge for VPC,
database networking, compute networking, and OpenSearch networking. Those
bridge keys are always emitted; downstream RGDs do not depend on network
