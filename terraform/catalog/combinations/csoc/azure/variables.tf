...
###############################################################################
variable "enable_vpc" {
  description = "Enable VNet module"
  type        = bool
}
...
variable "vpc_name" {
  description = "Alias for vnet_name (provider-agnostic naming)"
  type        = string
  default     = ""
}

variable "vpc_cidr" {
  description = "CIDR block for the VNet (provider-agnostic)"
  type        = string
  default     = ""
}
...
variable "existing_vpc_id" {
  description = "ID of an existing VNet to use (when enable_vpc is false)"
  type        = string
  default     = ""
}
...
variable "enable_k8s_cluster" {
  description = "Enable Kubernetes cluster module (AKS for Azure)"
  type        = bool
}
