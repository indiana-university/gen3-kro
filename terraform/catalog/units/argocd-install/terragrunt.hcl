terraform {
  source = "${get_repo_root()}/${values.modules_path}//k8s-argocd-install"
}
...
inputs = {
  ...
  argocd_self_managed_role_arn = dependency.controller_iam.outputs.argocd_self_managed_role_arn
}
