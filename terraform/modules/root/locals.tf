  ...
  addons_metadata = merge(
    {
      ...
      "${var.hub_alias}_account_id"   = module.eks-hub.account_id
    ...
    #---------------------------------------------------------------------------------------#
    {
      ...
      "${var.hub_alias}-${service}-ack-controller" => role.arn
    },
    #---------------------------------------------------------------------------------------#
    ...
    merge([
      for spoke_alias, arn_maps in local.ack_spoke_role_arns_by_spoke : {
        for service, arn in arn_maps :
        "${spoke_alias}-${service}-ack-controller" => arn
      }
    ]...),
    #---------------------------------------------------------------------------------------#
    ...
    #---------------------------------------------------------------------------------------#
    {
      ...
      "${spoke_alias}_account_id" => spoke_data.account_id
    },
    {
