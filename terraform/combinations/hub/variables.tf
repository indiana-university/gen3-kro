...
###############################################################################
variable "enable_ack" {
  description = "Enable ACK modules (computed from ack_configs)"
  type        = bool
  default     = false
}
...
variable "enable_ack_spoke_roles" {
  description = "Enable ACK spoke role module (computed)"
  type        = bool
  default     = false
}
...
variable "spoke_arn_inputs" {
  description = "Map of spoke ARNs by spoke alias and controller (loaded from JSON files or passed directly)"
  type        = map(map(any))
  default     = {}
  # Example structure:
  # {
