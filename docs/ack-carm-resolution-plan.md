...
```
ACK.Recoverable: AccessDenied: User: arn:aws:sts::859011005590:assumed-role/gen3-csoc-dev-ack-shared-csoc-source/... not authorized to perform sts:AssumeRole on resource: arn:aws:iam::859011005590:role/ack-workload-ack-controller
```
...
```json
{
  "Condition": {
    ...
    "ArnLike": { "aws:PrincipalArn": "arn:aws:iam::859011005590:role/*ack-shared-*-source" }
  }
}
```
...
- Only principals matching `arn:aws:iam::859011005590:role/*ack-shared-*-source` can assume the role
